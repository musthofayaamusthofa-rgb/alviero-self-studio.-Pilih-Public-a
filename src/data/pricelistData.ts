...
export const CATEGORIES: CategoryInfo[] = [
  ...
  },
  {
    ...
    name: 'Maternity',
    subPackageCount: 2,
    subPackageNote: '2 Sub Paket (Solo/Couple, Family)',
  ...
  },
  {
    ...
    name: 'Prewed',
    subPackageCount: 4,
    subPackageNote: '4 Sub Paket (Studio Mini, Studio Grand, Outdoor, Full Package)',
  ...
  },
  {
    ...
    name: 'Couple',
    subPackageCount: 2,
    subPackageNote: '2 Sub Paket (Sweet, Romantic Deluxe)',
  ...
  },
  {
    ...
    name: 'Sewa Studio',
    subPackageCount: 1,
    subPackageNote: '1 Sub Paket (Hourly Rental)',
  ...
  },
  {
    ...
    name: 'Undangan',
    subPackageCount: 1,
    subPackageNote: '1 Sub Paket (Undangan Digital & Cetak)',
  ...
  },
  {
    ...
    name: 'Self Studio',
    subPackageCount: 6,
    subPackageNote: '6 Sub Paket (2 Special, 2 Normal, 2 Color Spotlight)',
...
export const PACKAGES: PackageItem[] = [
  // ==================== 1. BIRTHDAY PACKAGES (4 Sub Paket Resmi) ====================
  {
  ...
  // ==================== 2. GROUP PACKAGES (4 Sub Paket Resmi) ====================
  {
  ...
  // ==================== 3. GRADUATION OUTDOOR PACKAGES (6 Sub Paket) ====================
  {
  ...
  // ==================== 4. FAMILY PACKAGES (2 Sub Paket Resmi) ====================
  {
  ...
  // ==================== 5. PERSONAL PACKAGES (2 Sub Paket Resmi) ====================
  {
  ...
  // ==================== 6. GRADUATION INDOOR (5 Sub Paket Resmi) ====================
  {
  ...
  // ==================== 8.5 COUPLE PACKAGES (2 Sub Paket Resmi) ====================
  {
  ...
  // ==================== 9. PREWED PACKAGES (4 Sub Paket Resmi) ====================
  {
  ...
  // ==================== 11. SEWA STUDIO (1 Sub Paket Resmi) ====================
  {
  ...
  // ==================== PASS FOTO PACKAGES (3 Sub Paket) ====================
  {
    id: 'passfoto-1',
    name: 'Pass Foto 1 (Paket 1)',
    category: 'pass-foto',
    tag: 'Setengah Badan • 3 Warna BG',
    durationMinutes: 15,
    selectionTimeMinutes: 10,
    includedPeople: 1,
    includedPrints: 'Cetak 1 Ukuran Pass Foto',
    ...
    price: 50000,
    originalPrice: 65000,
    description: '3 Warna background edit, maks 1 outfit, 1 edit foto setengah badan, file edit via WA Dokumen, dan cetak 1 ukuran pass foto.',
    highlights: [
      '3 Warna Background Edit',
      'Maksimal 1 Outfit',
      '1 Edit Foto (Setengah Badan)',
      'File Edit dikirim via Dokumen WhatsApp',
      'Cetak 1 Ukuran Pass Foto'
    ],
    popular: true,
    image: '/images/poster-passfoto.png'
  },
  {
    ...
    description: '3 Background edit setengah badan + edit 1 full badan (setengah badan & full badan), file edit via WA Dokumen, maks 1 outfit, dan cetak 1 ukuran pass foto.',
    highlights: [
      '3 Background Edit Setengah Badan',
      'Edit 1 Full Badan',
      'Foto Setengah Badan & Full Badan',
      'File Edit dikirim via Dokumen WhatsApp',
      'Maksimal 1 Outfit',
      'Cetak 1 Ukuran Pass Foto'
    ],
  ...
  {
    id: 'passfoto-3',
    name: 'Pass Foto 3 (Paket Nikah 2 Orang)',
    category: 'pass-foto',
    tag: 'Paket Nikah 2 Orang',
    durationMinutes: 20,
    selectionTimeMinutes: 10,
    includedPeople: 2,
    includedPrints: 'Masing-masing Cetak 1 Ukuran Pass Foto',
    ...
    price: 95000,
    originalPrice: 120000,
    description: 'Paket nikah resmi untuk 2 orang. 3 warna background edit, masing-masing 1 edit foto, file edit via Dokumen WA, dan masing-masing cetak 1 ukuran pass foto.',
    highlights: [
      'Paket Nikah Untuk 2 Orang',
      '3 Warna Background Edit',
      'Masing-masing 1 Edit Foto',
      'File Edit dikirim via Dokumen WhatsApp',
      'Masing-masing Cetak 1 Ukuran Pass Foto'
    ],
    popular: true,
...
export const STUDIO_BRANCHES: BranchInfo[] = [
  {
    ...
    address: 'https://maps.app.goo.gl/oxtptpr3RSDL9zCj6',
    badge: 'Studio 1',
  ...
  },
  {
    ...
    address: 'https://maps.app.goo.gl/W4Jojd1B9TBZxWWP9',
    badge: 'Studio 2',
...
// 18 Slot Jadwal untuk Studio Foto Profesional (Wisuda, Family, Group, Maternity, dll)
...
// 18 Slot Jadwal untuk Ruang Bilik Self Studio (Shutter Mandiri)
    ...
    rules: [
      {
        ...
        suffix: ' dengan ada charge 25K (kecuali wisuda outdoor tanpa biaya charge)'
      },
      {
        text: 'Apabila reservasi mendekati jam tutup dan ada keterlambatan dan waktu selesai lewat jam operasional dikenakan charge 25K',
        highlight: '',
        suffix: ''
      },
      {
