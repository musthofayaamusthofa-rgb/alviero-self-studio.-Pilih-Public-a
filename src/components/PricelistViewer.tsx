...
export const PricelistViewer: React.FC<PricelistViewerProps> = ({
  ...
  const additionalMenuButtons = [
    {
      ...
      cardBg: 'bg-[#CBA3A1]',
      cardBorder: 'border-[#BE9593]',
      hoverBorder: 'hover:border-[#A87D7C]',
      iconBg: 'bg-white',
      iconText: 'text-[#2E1E21]',
      badgeBg: 'bg-white/40',
      badgeText: 'text-[#2E1E21]',
    ...
    },
    {
      ...
      cardBg: 'bg-[#8DA4B8]',
      cardBorder: 'border-[#7E96AA]',
      hoverBorder: 'hover:border-[#6A8499]',
      iconBg: 'bg-white',
      iconText: 'text-[#152330]',
      badgeBg: 'bg-white/40',
      badgeText: 'text-[#152330]',
      badgeBorder: 'border-white/50',
      btnText: 'text-[#152330]',
      targetPackageIds: []
    }
  ...
  const STUDIO_GALLERY_PHOTOS: StudioGalleryPhoto[] = [
    {
      id: 'photo-grad-indoor-1',
      title: 'Foto Wisuda Toga Klasik & Map Ijazah',
    ...
    {
      id: 'photo-grad-indoor-2',
      title: 'Pose Elegan Wisudawati Toga & Buket Bunga',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-supreme-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-2.jpg',
      description: 'Pose anggun memegang buket bunga wisuda dengan senyum bahagia merayakan gelar sarjana baru.',
      conceptNote: 'Pencahayaan studio lembut untuk menonjolkan detail riasan dan busana toga wisudawati.',
      tags: ['#Wisudawati', '#BuketWisuda', '#SarjanaBaru']
    },
    {
      id: 'photo-grad-indoor-3',
      title: 'Foto Formal Kelulusan Sarjana Studio',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-elegant-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-3.jpg',
      description: 'Foto portrait kelulusan resmi dengan background studio elegan dan komposisi presisi.',
      conceptNote: 'Pengarahan gaya formal berwibawa cocok untuk arsip kenangan keluarga dan cetak frame besar.',
      tags: ['#FotoFormal', '#Sarjana', '#WisudaStudio']
    },
    {
      id: 'photo-grad-indoor-4',
      title: 'Sesi Foto Wisuda Bersama Keluarga Tercinta',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-infinity-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-4.jpg',
      description: 'Momen penuh rasa bangga dan haru wisudawan bersama kedua orang tua tercinta di studio foto Alviero.',
      conceptNote: 'Komposisi pose keluarga yang hangat, rapi, dan penuh kebanggaan orang tua.',
      tags: ['#WisudaKeluarga', '#BanggakanOrangTua', '#FotoKeluargaWisuda']
    },
    {
      id: 'photo-grad-indoor-5',
      title: 'Wisuda Modern Spotlight & Pose Berkarakter',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-bundling-ultimate-1',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-5.jpg',
      description: 'Konsep foto wisuda kekinian dengan efek pencahayaan modern spotlight artistik berkarakter.',
      conceptNote: 'Nuansa foto studio modern estetik untuk konten media sosial dan portofolio wisuda.',
      tags: ['#WisudaAesthetic', '#ModernSpotlight', '#FotoWisudaHits']
    },
    {
      id: 'photo-grad-indoor-6',
      title: 'Potret Sarjana Prestasi & Piagam Kelulusan',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-supreme-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-6.jpg',
      description: 'Dokumentasi bangga atas pencapaian gelar sarjana lengkap dengan medali dan selempang gelar cumlaude.',
      conceptNote: 'Penataan properti medali dan selempang rapi untuk hasil foto kelulusan berkesan abadi.',
      tags: ['#SarjanaCumlaude', '#MedaliWisuda', '#Kelulusan']
    },
    {
      id: 'photo-grad-indoor-7',
      title: 'Pose Ceria Wisuda Bareng Sahabat Satu Almamater',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-bundling-ultimate-2',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-7.jpg',
      description: 'Ekspresi ceria dan kompak merayakan kelulusan bersama sahabat seperjuangan skripsi di kampus.',
      conceptNote: 'Pose interaktif, bebas, dan ceria bersama teman satu angkatan.',
      tags: ['#WisudaSahabat', '#LulusBareng', '#SquadWisuda']
    },
    {
      id: 'photo-grad-indoor-8',
      title: 'Foto Wisuda Toga Lengkap dengan Bingkai Mewah',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-infinity-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-8.jpg',
      description: 'Hasil cetak foto wisuda premium yang siap dipajang dengan frame bingkai minimalis eksklusif.',
      conceptNote: 'Pengambilan gambar beresolusi tinggi yang tajam untuk dicetak ukuran 10Rs hingga 16Rs.',
      tags: ['#FrameWisuda', '#CetakFotoWisuda', '#PajanganStudio']
    },
    {
      id: 'photo-grad-indoor-9',
      title: 'Momen Hangat Wisudawan Bersama Orang Tua',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-elegant-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-9.jpg',
      description: 'Ungkapan syukur dan terima kasih kepada orang tua dalam frame foto wisuda yang sangat menyentuh.',
      conceptNote: 'Momen hangat orang tua memasangkan topi toga kepada anak tercinta.',
      tags: ['#BaktiOrangTua', '#SyukurWisuda', '#KeluargaBahagia']
    },
    {
      id: 'photo-grad-indoor-10',
      title: 'Ekspresi Bahagia Kelulusan Sarjana Alviero',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-supreme-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-10.jpg',
      description: 'Senyum lepas dan ekspresi bahagia setelah resmi menyelesaikan masa studi perkuliahan.',
      conceptNote: 'Pengarahan fotografer profesional agar wisudawan rileks dan tampil percaya diri maksimal.',
      tags: ['#HappyGraduation', '#LulusKuliah', '#AlvieroStudio']
    },
    {
      id: 'photo-grad-indoor-11',
      title: 'Pose Anggun Wisudawati & Toga Kebanggaan',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-elegant-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-11.jpg',
      description: 'Portrait wisudawati memancarkan pesona keanggunan wanita berpendidikan tinggi.',
      conceptNote: 'Sudut pengambilan foto yang mempercantik proporsi wajah dan postur wisudawati.',
      tags: ['#WisudawatiCantik', '#TogaKebanggaan', '#FotoStudioWisuda']
    },
    {
      id: 'photo-grad-indoor-12',
      title: 'Potret Wisuda Studio Latar Estetik & Minimalis',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-indoor-infinity-scholar',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-12.jpg',
      description: 'Konsep foto wisuda studio bernuansa bersih, elegan, dan estetik khas Alviero Studio.',
      conceptNote: 'Latar background bersih yang membuat fokus utama tertuju pada wisudawan.',
      tags: ['#LatarEstetik', '#MinimalisWisuda', '#StudioModern']
    },
    {
      id: 'photo-grad-indoor-13',
      title: 'Foto Wisuda Exclusive Kak Zahfran di Alviero Studio',
      category: 'grad-indoor',
      packageName: 'Paket Wisuda Indoor',
      icon: '🎓',
      targetPackageId: 'grad-bundling-ultimate-1',
      imageUrl: '/images/gallery/graduation-indoor/grad-indoor-13.jpg',
      description: 'Sesi pemotretan wisuda premium dengan sentuhan warna tone khas dan pengeditan kulit halus natural.',
      conceptNote: 'Warna tone eksklusif yang tahan lama dan tidak lekang oleh waktu.',
      tags: ['#WisudaExclusive', '#AlvieroPortofolio', '#MasterpieceWisuda']
    },
    {
      id: 'photo-grad-outdoor-1',
