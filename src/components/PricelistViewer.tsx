  ...
  const additionalMenuButtons = [
    {
      ...
      cardBg: 'bg-[#cda7a7]',
      cardBorder: 'border-[#b89090]',
      hoverBorder: 'hover:border-[#964d74]',
      iconBg: 'bg-[#b89090]',
      iconText: 'text-white',
      badgeBg: 'bg-[#f2e4e4]',
      badgeText: 'text-[#5e3838]',
      badgeBorder: 'border-[#e4d0d0]',
      btnText: 'text-[#7d4444]',
    ...
    },
    {
      ...
      cardBg: 'bg-[#b2c3ad]',
      cardBorder: 'border-[#9aae93]',
      hoverBorder: 'hover:border-[#6a5e35]',
      iconBg: 'bg-[#9aae93]',
      iconText: 'text-white',
      badgeBg: 'bg-[#e4ece2]',
      badgeText: 'text-[#344e2f]',
      badgeBorder: 'border-[#d0ded0]',
      btnText: 'text-[#6a5e35]',
      targetPackageIds: []
    }
  ];
